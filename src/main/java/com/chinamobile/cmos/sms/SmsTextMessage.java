...
public class SmsTextMessage extends SmsConcatMessage implements Serializable {
	...
	public SmsTextMessage(String msg) {
		if (haswidthChar(msg))
			...
			setText(msg, SmsPduUtil.defaultmsgfmt);
	}
	...
	public SmsUserData getUserData() {
		...
		case UCS2:
		case RESERVED:
			ud = new SmsUserData(text_.getBytes(SmsPduUtil.switchCharset(alp)), dcs_);
			break;
		default:
			ud = new SmsUserData(text_.getBytes(SmsPduUtil.switchCharset(SmsAlphabet.UCS2)),
